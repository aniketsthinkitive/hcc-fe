...
interface CancellationChargeSearchFilterProps {
  onSearch?: (searchTerm: string) => void;
  onFilter?: () => void;
}

const CancellationChargeSearchFilter: React.FC<CancellationChargeSearchFilterProps> = ({ 
  onSearch, 
  onFilter 
}) => {
...
export default CancellationChargeSearchFilter;
